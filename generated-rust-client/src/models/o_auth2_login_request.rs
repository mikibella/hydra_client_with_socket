...
pub struct OAuth2LoginRequest {
    ...
    #[serde(rename = "client")]
    pub client: Box<models::OAuth2Client>,
...
impl OAuth2LoginRequest {
    pub fn new(challenge: String, client: models::OAuth2Client, request_url: String, skip: bool, subject: String) -> OAuth2LoginRequest {
        OAuth2LoginRequest {
            challenge,
